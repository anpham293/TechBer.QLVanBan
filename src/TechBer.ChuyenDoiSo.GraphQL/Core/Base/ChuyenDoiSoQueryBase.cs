...
namespace TechBer.ChuyenDoiSo.Core.Base
{
    public abstract class ChuyenDoiSoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ChuyenDoiSoQueryBase(string fieldName,
