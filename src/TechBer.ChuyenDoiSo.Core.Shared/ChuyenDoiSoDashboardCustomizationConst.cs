...
{
    public class ChuyenDoiSoDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string BaoCaoChuyenDoiSo = "Widgets_Tenant_BaoCaoChuyenDoiSo";
                public const string BaoCaoTongHop = "Widgets_Tenant_BaoCaoTongHop";
                public const string BaoCaoDoiTuong = "Widgets_Tenant_BaoCaoDoiTuong";
            }
