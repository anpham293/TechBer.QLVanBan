...
using TechBer.ChuyenDoiSo.Controls;
using TechBer.ChuyenDoiSo.Dto;
using TechBer.ChuyenDoiSo.Extensions;
using TechBer.ChuyenDoiSo.Localization;
using TechBer.ChuyenDoiSo.UI;
using TechBer.ChuyenDoiSo.UI.Assets;
using TechBer.ChuyenDoiSo.Views;
using DependencyResolver = TechBer.ChuyenDoiSo.Core.Dependency.DependencyResolver;
...
namespace TechBer.ChuyenDoiSo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ChuyenDoiSo";
