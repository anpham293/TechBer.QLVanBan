...
namespace TechBer.ChuyenDoiSo.Web.Authentication.JwtBearer
{
    public class ChuyenDoiSoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ChuyenDoiSoJwtSecurityTokenHandler()
        {
