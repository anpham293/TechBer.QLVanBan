...
using TechBer.ChuyenDoiSo.Web.Authentication.JwtBearer;
using TechBer.ChuyenDoiSo.Web.Authentication.TwoFactor;
using TechBer.ChuyenDoiSo.Web.Chat.SignalR;
using TechBer.ChuyenDoiSo.Web.Configuration;
...
namespace TechBer.ChuyenDoiSo.Web
{
    ...
    public class ChuyenDoiSoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ChuyenDoiSoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ChuyenDoiSoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ChuyenDoiSoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ChuyenDoiSoWebCoreModule).Assembly);
        }
