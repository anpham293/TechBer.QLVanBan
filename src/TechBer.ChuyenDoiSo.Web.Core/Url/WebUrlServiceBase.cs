...
namespace TechBer.ChuyenDoiSo.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public string WebSiteRootAddressFormat => _appConfiguration[WebSiteRootAddressFormatKey] ?? "https://localhost:8888/";

        public string ServerRootAddressFormat => _appConfiguration[ServerRootAddressFormatKey] ?? "https://localhost:8888/";
