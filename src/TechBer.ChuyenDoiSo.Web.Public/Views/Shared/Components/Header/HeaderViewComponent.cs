...
using TechBer.ChuyenDoiSo.Web.Public.Startup;
using TechBer.ChuyenDoiSo.Web.Session;

namespace TechBer.ChuyenDoiSo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ChuyenDoiSoViewComponent
    {
