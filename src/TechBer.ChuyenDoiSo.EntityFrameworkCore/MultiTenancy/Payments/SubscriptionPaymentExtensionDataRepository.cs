...
{
    public class SubscriptionPaymentExtensionDataRepository : ChuyenDoiSoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ChuyenDoiSoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
