...
namespace TechBer.ChuyenDoiSo.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class ChuyenDoiSoScriptSrcTagHelper : TagHelper
    {
        ...
        public ChuyenDoiSoScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
