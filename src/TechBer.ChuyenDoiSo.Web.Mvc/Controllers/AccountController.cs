...
using TechBer.ChuyenDoiSo.Net.Sms;
using TechBer.ChuyenDoiSo.Notifications;
using TechBer.ChuyenDoiSo.Web.Models.Account;
using TechBer.ChuyenDoiSo.Security;
using TechBer.ChuyenDoiSo.Security.Recaptcha;
using TechBer.ChuyenDoiSo.Sessions;
using TechBer.ChuyenDoiSo.Url;
using TechBer.ChuyenDoiSo.Web.Authentication.External;
using TechBer.ChuyenDoiSo.Web.Security.Recaptcha;
using TechBer.ChuyenDoiSo.Web.Session;
using TechBer.ChuyenDoiSo.Web.Views.Shared.Components.TenantChange;

namespace TechBer.ChuyenDoiSo.Web.Controllers
{
    public class AccountController : ChuyenDoiSoControllerBase
    {
