namespace TechBer.ChuyenDoiSo.Web.Areas.App.Startup
{
    public class AppPageNames
    {
        ...
        {
            public const string UserDuAns = "QLVB.UserDuAns";
            public const string BaoCaoVanBanDuAns = "QLVB.BaoCaoVanBanDuAns";
            public const string TraoDoiVanBanDuAns = "QLVB.TraoDoiVanBanDuAns";
            public const string QuyetDinhs = "QLVB.QuyetDinhs";
            public const string ThungHoSos = "QuanLyKhoHoSo.ThungHoSos";
            ...
            public const string Chuongs = "QuanLyDanhMuc.Chuongs";
            public const string CapQuanLies = "QuanLyDanhMuc.CapQuanLies";
        ...
        {
            public const string SdtZalos = "QuanLySdtZalo.SdtZalos";
            public const string ChiTietThuHoies = "QuanLyThuHoiTamUng.ChiTietThuHoies";
        ...
        {
            public const string QuanLyChuyenDoiSo = "QuanLyChuyenDoiSo";
            public const string TieuChiDanhGias = "QuanLyChuyenDoiSo.TieuChiDanhGias";
            public const string DoiTuongChuyenDoiSos = "QuanLyChuyenDoiSo.DoiTuongChuyenDoiSos";
            public const string CayTieuChi = "QuanLyChuyenDoiSo.CayTieuChi";
