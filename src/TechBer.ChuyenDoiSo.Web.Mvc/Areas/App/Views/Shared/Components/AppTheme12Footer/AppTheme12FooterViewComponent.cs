...
namespace TechBer.ChuyenDoiSo.Web.Areas.App.Views.Shared.Components.AppTheme12Footer
{
    public class AppTheme12FooterViewComponent : ChuyenDoiSoViewComponent
    {
