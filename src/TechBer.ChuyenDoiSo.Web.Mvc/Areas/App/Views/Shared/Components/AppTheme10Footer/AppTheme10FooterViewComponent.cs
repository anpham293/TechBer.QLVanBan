...
namespace TechBer.ChuyenDoiSo.Web.Areas.App.Views.Shared.Components.AppTheme10Footer
{
    public class AppTheme10FooterViewComponent : ChuyenDoiSoViewComponent
    {
