...
using TechBer.ChuyenDoiSo.Configuration.Host;
using TechBer.ChuyenDoiSo.Editions;
using TechBer.ChuyenDoiSo.Timing;
using TechBer.ChuyenDoiSo.Timing.Dto;
using TechBer.ChuyenDoiSo.Web.Areas.App.Models.HostSettings;
...
namespace TechBer.ChuyenDoiSo.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : ChuyenDoiSoControllerBase
    {
