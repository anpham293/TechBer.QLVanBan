...
using TechBer.ChuyenDoiSo.Authorization.Permissions;
...
using TechBer.ChuyenDoiSo.Web.Areas.App.Models.Roles;
using TechBer.ChuyenDoiSo.Web.Areas.App.Models.Users;
...
namespace TechBer.ChuyenDoiSo.Web.Areas.App.Controllers
{
    ...
    public class UsersController : ChuyenDoiSoControllerBase
    {
