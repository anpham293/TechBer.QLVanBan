...
using TechBer.ChuyenDoiSo.Auditing.Exporting;
using TechBer.ChuyenDoiSo.Authorization;
using TechBer.ChuyenDoiSo.Authorization.Users;
using TechBer.ChuyenDoiSo.Dto;
using TechBer.ChuyenDoiSo.EntityHistory;
using EntityHistoryHelper = TechBer.ChuyenDoiSo.EntityHistory.EntityHistoryHelper;

namespace TechBer.ChuyenDoiSo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ChuyenDoiSoAppServiceBase, IAuditLogAppService
    {
