...
namespace TechBer.ChuyenDoiSo.QLVB
{
    ...
    public class BaoCaoVanBanDuAnsAppService : ChuyenDoiSoAppServiceBase, IBaoCaoVanBanDuAnsAppService
    {
        ...
        public BaoCaoVanBanDuAnsAppService(IRepository<BaoCaoVanBanDuAn> baoCaoVanBanDuAnRepository,
            IBaoCaoVanBanDuAnsExcelExporter baoCaoVanBanDuAnsExcelExporter,
        ...
        public async Task<GetBaoCaoVanBanDuAnForViewDto> GetBaoCaoVanBanDuAnForView(int id)
        {
            ...
            var output = new GetBaoCaoVanBanDuAnForViewDto
                {BaoCaoVanBanDuAn = ObjectMapper.Map<BaoCaoVanBanDuAnDto>(baoCaoVanBanDuAn)};

            if (output.BaoCaoVanBanDuAn.VanBanDuAnId != null)
            {
                var _lookupVanBanDuAn =
                    await _lookup_vanBanDuAnRepository.FirstOrDefaultAsync((int) output.BaoCaoVanBanDuAn.VanBanDuAnId);
            ...
            {
                var _lookupUser =
                    await _lookup_userRepository.FirstOrDefaultAsync((long) output.BaoCaoVanBanDuAn.UserId);
        ...
        public async Task<GetBaoCaoVanBanDuAnForEditOutput> GetBaoCaoVanBanDuAnForEdit(EntityDto input)
        {
            ...
            var output = new GetBaoCaoVanBanDuAnForEditOutput
                {BaoCaoVanBanDuAn = ObjectMapper.Map<CreateOrEditBaoCaoVanBanDuAnDto>(baoCaoVanBanDuAn)};
        ...
        protected virtual async Task Create(CreateOrEditBaoCaoVanBanDuAnDto input)
        {
            ...
            baoCaoVanBanDuAn.FileBaoCao = fileMau;
        ...
        protected virtual async Task Update(CreateOrEditBaoCaoVanBanDuAnDto input)
        {
            try
            {
                if (!string.IsNullOrEmpty(input.UploadedFileToken))
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(baoCaoVanBanDuAn.FileBaoCao))
                    {
                        var oldFileMau = JsonConvert.DeserializeObject<FileMauSerializeObj>(baoCaoVanBanDuAn.FileBaoCao);
                ...
                {
                    var baoCaoVanBanDuAn = await _baoCaoVanBanDuAnRepository.FirstOrDefaultAsync((int) input.Id);
                    baoCaoVanBanDuAn.UserId = input.UserId;
                    baoCaoVanBanDuAn.NoiDungCongViec = input.NoiDungCongViec;
                    baoCaoVanBanDuAn.MoTaChiTiet = input.MoTaChiTiet;
                    baoCaoVanBanDuAn.VanBanDuAnId = input.VanBanDuAnId;
                    await _baoCaoVanBanDuAnRepository.UpdateAsync(baoCaoVanBanDuAn);
        ...
        [AbpAuthorize(AppPermissions.Pages_BaoCaoVanBanDuAns)]
        public async Task<PagedResultDto<BaoCaoVanBanDuAnVanBanDuAnLookupTableDto>> GetAllVanBanDuAnForLookupTable(
        ...
        [AbpAuthorize(AppPermissions.Pages_BaoCaoVanBanDuAns)]
        public async Task<PagedResultDto<BaoCaoVanBanDuAnUserLookupTableDto>> GetAllUserForLookupTable(
            GetAllForLookupTableInput input)
        {
