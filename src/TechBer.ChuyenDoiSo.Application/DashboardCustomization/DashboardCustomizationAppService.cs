...
namespace TechBer.ChuyenDoiSo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ChuyenDoiSoAppServiceBase, IDashboardCustomizationAppService
    {
