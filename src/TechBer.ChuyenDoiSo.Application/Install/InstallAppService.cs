...
using TechBer.ChuyenDoiSo.Migrations.Seed.Host;
...
namespace TechBer.ChuyenDoiSo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ChuyenDoiSoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ChuyenDoiSoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ChuyenDoiSoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ChuyenDoiSoConsts.ConnectionStringName}", constring);
        }
