...
namespace TechBer.ChuyenDoiSo.QuanLyThuHoiTamUng
{
    ...
    public class DuAnThuHoiesAppService : ChuyenDoiSoAppServiceBase, IDuAnThuHoiesAppService
    {
		 ...
		 private readonly IDuAnThuHoiesExcelExporter _duAnThuHoiesExcelExporter;
		  ...
		  public DuAnThuHoiesAppService(IRepository<DuAnThuHoi, long> duAnThuHoiRepository, IDuAnThuHoiesExcelExporter duAnThuHoiesExcelExporter ) 
		  {
		 ...
		 public async Task<PagedResultDto<GetDuAnThuHoiForViewDto>> GetAll(GetAllDuAnThuHoiesInput input)
         {
			...
			var filteredDuAnThuHoies = _duAnThuHoiRepository.GetAll()
						.WhereIf(!string.IsNullOrWhiteSpace(input.Filter), e => false  || e.MaDATH.Contains(input.Filter) || e.Ten.Contains(input.Filter) || e.GhiChu.Contains(input.Filter))
						...
						.WhereIf(input.MinThoiHanBaoLanhHopDongFilter != null, e => e.ThoiHanBaoLanhHopDong >= input.MinThoiHanBaoLanhHopDongFilter)
						.WhereIf(input.MaxThoiHanBaoLanhHopDongFilter != null, e => e.ThoiHanBaoLanhHopDong <= input.MaxThoiHanBaoLanhHopDongFilter)
						.WhereIf(input.MinThoiHanBaoLanhTamUngFilter != null, e => e.ThoiHanBaoLanhTamUng >= input.MinThoiHanBaoLanhTamUngFilter)
						.WhereIf(input.MaxThoiHanBaoLanhTamUngFilter != null, e => e.ThoiHanBaoLanhTamUng <= input.MaxThoiHanBaoLanhTamUngFilter)
		 ...
		 public async Task<GetDuAnThuHoiForEditOutput> GetDuAnThuHoiForEdit(EntityDto<long> input)
         {
		    ...
		    var output = new GetDuAnThuHoiForEditOutput {DuAnThuHoi = ObjectMapper.Map<CreateOrEditDuAnThuHoiDto>(duAnThuHoi)};
