...
{
    public class SessionAppService : ChuyenDoiSoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = ChuyenDoiSoConsts.Currency,
                    CurrencySign = ChuyenDoiSoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ChuyenDoiSoConsts.AllowTenantsToChangeEmailSettings,
