...
using TechBer.ChuyenDoiSo.Web.Models.Consent;

namespace TechBer.ChuyenDoiSo.Web.Host.Controllers
{
    public class ConsentController : ChuyenDoiSoControllerBase
    {
