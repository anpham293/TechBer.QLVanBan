...
namespace TechBer.ChuyenDoiSo.Web.Startup
{
    ...
    public class ChuyenDoiSoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ChuyenDoiSoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ChuyenDoiSoWebHostModule).GetAssembly());
        }
