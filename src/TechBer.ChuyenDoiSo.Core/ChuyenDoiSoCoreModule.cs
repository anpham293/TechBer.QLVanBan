...
using TechBer.ChuyenDoiSo.Authorization.Ldap;
...
using TechBer.ChuyenDoiSo.DashboardCustomization.Definitions;
using TechBer.ChuyenDoiSo.Debugging;
using TechBer.ChuyenDoiSo.DynamicEntityParameters;
using TechBer.ChuyenDoiSo.Features;
...
using TechBer.ChuyenDoiSo.Net.Emailing;
using TechBer.ChuyenDoiSo.Notifications;
using TechBer.ChuyenDoiSo.WebHooks;

namespace TechBer.ChuyenDoiSo
{
    [DependsOn(
        typeof(ChuyenDoiSoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ChuyenDoiSoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ChuyenDoiSoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ChuyenDoiSoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ChuyenDoiSoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ChuyenDoiSoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ChuyenDoiSoCoreModule).GetAssembly());
        }
