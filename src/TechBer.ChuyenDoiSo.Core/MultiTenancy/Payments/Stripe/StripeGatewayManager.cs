...
{
    public class StripeGatewayManager : ChuyenDoiSoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ChuyenDoiSo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ChuyenDoiSoConsts.Currency;
        }
