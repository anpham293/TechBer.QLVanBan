...
using TechBer.ChuyenDoiSo.MultiTenancy.Demo;
...
namespace TechBer.ChuyenDoiSo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ChuyenDoiSoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ChuyenDoiSoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
