...
namespace TechBer.ChuyenDoiSo.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<ChuyenDoiSoDbContext>>()
            ...
            new ChuyenDoiSoDbContext(builder.Options).Database.EnsureCreated();
        }
