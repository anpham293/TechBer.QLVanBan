...
using TechBer.ChuyenDoiSo.MultiTenancy.HostDashboard;
...
namespace TechBer.ChuyenDoiSo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ChuyenDoiSoDbContext context, SubscriptionPayment subscriptionPayment)
        {
